setConstructorS3("MskccTotalCopyNumberTcgaDataFileSet", function(...) {
  extend(TcgaDataFileSet(...), "MskccTotalCopyNumberTcgaDataFileSet");
})



setMethodS3("exportTotal", "MskccTotalCopyNumberTcgaDataFileSet", function(this, tags=c("*"), unf, ..., rootPath="totalAndFracBData", verbose=FALSE) {
  # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  # Validate arguments
  # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  # Argument 'tags':
...
# 2010-01-03
# o Added exportTotal().
# o Created from HarvardTotalCopyNumberTcgaDataFileSet.R.
############################################################################
