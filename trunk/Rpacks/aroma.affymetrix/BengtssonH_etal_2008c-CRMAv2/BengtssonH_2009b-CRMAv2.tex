...
%% Moreover, as long as there are enough loci that are exclusively digested by each enzyme, so that the enzyme-specific fragment-length effects can be estimated, then the above method also applies to cases where more than two enzymes are used.  See Supplementary Notes for the number of loci exclusively on one enzyme.
...
\begin{center}
 ...
 \resizebox{0.96\columnwidth}{!}{\includegraphics{GSM337641,chr01,100_1-107_5,ratios,ROC}} \\
\end{center}
 \caption{
...
\begin{center}
 ...
 \resizebox{0.96\columnwidth}{!}{\includegraphics{GSM337641,chr10,61-69,ratios,ROC}} \\
\end{center}
 \caption{
