...
# @RdocMethod "[["
#
# @title "Gets a subset of the files in the file set"
#
# \description{
#   @get "title".
# }
...
#
# \arguments{
#  \item{i}{An @integer index @vector specifying which files to be returned.}
#  \item{drop}{If @TRUE and only one file is returned, the file is
#    return directly, otherwise as an element in a list.}
#  \item{...}{Not used.}
# }
#
# \value{
#   Returns a @list of @see "AffymetrixFile" objects, or a single
#   @see "AffymetrixFile" object if \code{drop} is @TRUE and only
...
# }
#*/###########################################################################
setMethodS3("[[", "AffymetrixFileSet", function(this, i=NULL, drop=TRUE) {
  # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  # Validate arguments
  # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  # Argument 'i':
...
#
# \arguments{
#  \item{i}{An @integer index @vector specifying the files to be returned.}
...
# }
#*/###########################################################################
setMethodS3("[", "AffymetrixFileSet", function(this, i=NULL, ...) {
  extract(this, files=i, ...);
})
