###########################################################################/**
# @RdocClass AffymetrixTotalCnLiWongModel
#
# @title "The AffymetrixTotalCnLiWongModel class"
#
# \description{
#  @classhierarchy
#
...
# }
#*/###########################################################################
setConstructorS3("AffymetrixTotalCnLiWongModel", function(..., name="modelTotalCnLiWong") {
  this <- extend(AffymetrixLiWongModel(..., name=name), "AffymetrixTotalCnLiWongModel");
  this <- setup(this);
  this;
})

setMethodS3("setup", "AffymetrixTotalCnLiWongModel", function(this, ...) {
...
setMethodS3("fit", "AffymetrixTotalCnLiWongModel", function(this, ..., transform=NULL, postCdfTransform=NULL) {
...
# HISTORY:
# 2006-08-28
# o Renamed from AffymetrixCnLiWongModel to AffymetrixTotalCnLiWongModel.
# 2006-08-27
# o Created.
############################################################################
