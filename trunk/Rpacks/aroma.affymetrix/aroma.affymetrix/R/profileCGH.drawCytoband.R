...
setMethodS3("drawCytoband", "default", function(fit, ...) {
  warning("No drawCytoband() implementation available for this class: ", class(fit)[1]);
}, protected=FALSE);
...
# HISTORY:
# 2007-09-04
# o Renamed from drawCytoBand() to drawCytoband().
# o Now data("cytoband") is loaded to the local environment.
# o Extracted new function drawCytoband() for profileCGH from plotProfile2()
#   of the same class.
# 2007-08-22
