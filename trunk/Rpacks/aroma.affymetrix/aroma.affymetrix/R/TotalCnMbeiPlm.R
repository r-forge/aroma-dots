###########################################################################/**
# @RdocClass TotalCnMbeiPlm
#
# @title "The TotalCnMbeiPlm class"
#
# \description{
#  @classhierarchy
#
...
# }
#*/###########################################################################
setConstructorS3("TotalCnMbeiPlm", function(..., name="modelTotalCnLiWong") {
  this <- extend(MbeiPlm(..., name=name), "TotalCnMbeiPlm");
  this <- setup(this);
  this;
})

setMethodS3("setup", "TotalCnMbeiPlm", function(this, ...) {
...
setMethodS3("fit", "TotalCnMbeiPlm", function(this, ..., transform=NULL, postCdfTransform=NULL) {
...
# HISTORY:
# 2006-08-28
# o Renamed from AffymetrixCnLiWongModel to TotalCnMbeiPlm.
# 2006-08-27
# o Created.
############################################################################
