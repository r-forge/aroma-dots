...
#   \item{overwrite}{If @FALSE and the file already exists, then an error 
#      is thrown.}
setMethodS3("allocateFromCdf", "AffymetrixCelFile", function(static, cdf, name, tags=NULL, path=".", ..., overwrite=FALSE, verbose=FALSE) {
  # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  # Validate arguments
  # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  # Argument 'cdf':
