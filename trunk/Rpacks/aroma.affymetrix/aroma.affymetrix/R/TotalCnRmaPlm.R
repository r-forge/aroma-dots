###########################################################################/**
# @RdocClass TotalCnRmaPlm
#
# @title "The TotalCnRmaPlm class"
#
# \description{
#  @classhierarchy
#
...
# }
#*/###########################################################################
setConstructorS3("TotalCnRmaPlm", function(..., name="modelTotalCnRma") {
  this <- extend(RmaPlm(..., name=name), "TotalCnRmaPlm")
  this <- setup(this);
  this;
})


setMethodS3("setup", "TotalCnRmaPlm", function(this, ...) {
...
setMethodS3("fit", "TotalCnRmaPlm", function(this, ..., transform=NULL, postCdfTransform=NULL) {
...
# HISTORY:
# 2006-08-28
# o Renamed from AffymetrixCnRmaModel to TotalCnRmaPlm.
# 2006-08-26
# o Created.
############################################################################
