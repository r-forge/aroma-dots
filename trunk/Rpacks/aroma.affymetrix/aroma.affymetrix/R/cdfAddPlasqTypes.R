...
#  allele B, as used by [1], and adds an integer [0,15] interepreted
#  by PLASQ [1] as one of 16 probe types.
#  PLASQ labels the different types as:
#  0=MMoBR, 1=MMoBF, 2=MMcBR, 3=MMcBF, 4=MMoAR, 5=MMoAF, 6=MMcAR, 7=MMcAF, 
#  8=PMoBR, 9=PMoBF, 10=PMcBR, 11=PMcBF, 12=PMoAR, 13=PMoAF, 14=PMcAR, 15=PMcAF.
#
...
#
#  Example: (PM,A,c,-) = 8 + 4 + 2 + 0 = 14 (=PMcAR)
# }
#
# @author
#
